...
lw=1
# ax.plot(x1, Col_h_m,color='#f57e20', linewidth=lw,markersize=2, label='PME')
plt.errorbar(x1, Col_h_m,yerr=error,fmt='-o',color='#f68c28', linewidth=lw,markersize=2)

# ax.plot(x1, PMB_h_m,color='#faa819', linewidth=lw, linestyle='--',dashes=(2, 3),markersize=2, label='PMB')
plt.errorbar(x1, PMB_h_m,yerr=error2,fmt='-^',color='#b24426', linewidth=lw,linestyle='--',markersize=2)

# ax.plot(x1, PMBN_h_m,color='#ffd27c', linewidth=lw, linestyle='--', dashes=(2, 3),markersize=2, label='PMBN')
plt.errorbar(x1, PMBN_h_m,yerr=error3,fmt='-^',color='#ef5c4d', linewidth=lw,linestyle='--',markersize=2)

# ax.plot(x1, S_h_m,color='#f8a869', linewidth=lw,markersize=2, label='Short Poly E')
plt.errorbar(x1, S_h_m,yerr=error5,fmt='-o',color='#ffd27c', linewidth=lw,markersize=2)

ax.plot(x2, h_a, color='darkgray',linewidth=1)
plt.errorbar(x2,h_a, yerr=error4, color='darkgray',  fmt='s',markersize=2)
...
plt.show()
# fig1.savefig('/Users/selenm/polybox/Colistin_Project_Collab/Selen/Biophysical_change/Height_change_titration.pdf', format='pdf',  dpi=600, bbox_inches = 'tight',pad_inches=0.01)
...
# ax.plot(x1, Col_a_m,color='#47bbc3', linewidth=lw,markersize=2, label='PME')
plt.errorbar(x1, Col_a_m,yerr=err,fmt='-o',color='#47bbc3', linewidth=lw,markersize=2)

# ax.plot(x1, PMB_a_m,color='#4680be', linewidth=lw, linestyle='--',dashes=(2, 3),markersize=2, label='PMB')
plt.errorbar(x1, PMB_a_m,yerr=err2,fmt='-^',color='#354982', linewidth=lw, linestyle='--',markersize=2)

# ax.plot(x1, PMBN_a_m,color='#6cacd3', linewidth=lw, linestyle='--',dashes=(2, 3),markersize=2, label='PMBN')
plt.errorbar(x1, PMBN_a_m,yerr=err3,fmt='-^',color='#4481bf', linewidth=lw, linestyle='--',markersize=2)

# ax.plot(x1, S_a_m,color='#92d4d5', linewidth=lw,markersize=2, label='Short Poly E')
plt.errorbar(x1, S_a_m,yerr=err5,fmt='-o',color='#abdee1', linewidth=lw,markersize=2)

ax.plot(x2, a_a,color="darkgray",linewidth=1)
plt.errorbar(x2,a_a, yerr=error4, color="darkgray",  fmt='s',markersize=2)
...
plt.show()
# fig2.savefig('/Users/selenm/polybox/Colistin_Project_Collab/Selen/Biophysical_change/Area_change_titration.pdf', format='pdf',  dpi=600, bbox_inches = 'tight',pad_inches=0.01)
